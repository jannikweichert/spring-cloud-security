...
:githubmaster: {github}/blob/master/spring-cloud-security
...
See
{githubmaster}/src/main/java/org/springframework/cloud/security/oauth2/proxy/ProxyAuthenticationProperties.java[
